...
def run_benchmarks(comm, file_paths, total_seqs_list, n_steps_list, graph_structures, num_processors):
    ...
    for benchmark in benchmarks:
        ...
        if benchmark['graph_structure'] == 'ring':
            total_time, consensus_iterations, consensus_theta, avg_diff_values, obj_values, L, q = run_dgd_ring(comm, benchmark['file_path'], benchmark['total_seqs'], benchmark['n_steps'])
        elif benchmark['graph_structure'] == 'complete':
            total_time, consensus_iterations, consensus_theta, avg_diff_values, obj_values, L, q = run_dgd_complete(comm, benchmark['file_path'], benchmark['total_seqs'], benchmark['n_steps'])
...
if __name__ == "__main__":
    ...
    total_seqs_list = [1024,2048,4096,8192]
    n_steps_list = [15]
